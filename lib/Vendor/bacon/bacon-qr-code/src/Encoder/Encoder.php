...
namespace OCA\TwoFactorKannel\Vendor\BaconQrCode\Encoder;

use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\BitArray;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\CharacterSetEci;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\ErrorCorrectionLevel;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\Mode;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\ReedSolomonCodec;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Common\Version;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Exception\WriterException;
use SplFixedArray;
/**
 * Encoder.
 * @internal
