...
namespace OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Image;

use OCA\TwoFactorKannel\Vendor\BaconQrCode\Exception\RuntimeException;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Color\Alpha;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Color\Cmyk;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Color\ColorInterface;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Color\Gray;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Color\Rgb;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\Close;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\Curve;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\EllipticArc;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\Line;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\Move;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\Path\Path;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\RendererStyle\Gradient;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\RendererStyle\GradientType;
/** @internal */
