...
namespace OCA\TwoFactorKannel\Vendor\BaconQrCode;
...
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Encoder\Encoder;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Exception\InvalidArgumentException;
use OCA\TwoFactorKannel\Vendor\BaconQrCode\Renderer\RendererInterface;
/**
 * QR code writer.
 * @internal
 */
